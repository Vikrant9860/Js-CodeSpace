...
/* SHALLOW COPIES - A shallow copy of an object is a copy whose properties share
 ...
 console.log(myArr[2]);   // 3          indexing of array starts from the 2
...
myArr.pop(7)   // [ 1, 2, 3, 4, 5, 6]
 ...
 console.log(myArr.indexOf(9))   // -1 because the 9 is not present in the array 
 ...
 console.log(myArr.splice(1,3));  // [ 2, 3, 4 ]          last elment is included here
